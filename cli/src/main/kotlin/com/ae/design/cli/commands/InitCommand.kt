...
class InitCommand : CliktCommand(name = "init") {
    ...
    override fun help(context: Context) = "Initialize AEDesign in your project"
    ...
    override fun run() {
        if (ConfigManager.exists()) {
            echo("aedesign.json already exists. Overwrite? (y/N) ", trailingNewline = false)
        ...
        echo("")
        echo("  Then run: aedesign add button")
        echo("")
    }
