...
import com.ae.design.cli.model.RegistryComponent
import com.ae.design.cli.model.AEConfig
import com.ae.design.cli.registry.ConfigManager
import com.ae.design.cli.registry.PackageRewriter
...
class AddCommand : CliktCommand(name = "add") {
    ...
    private fun resolveTargets(): Triple<String, String, String> {
        val defaultRegistry = "https://abdo-essam.github.io/AEDesign/r"
        ...
        echo("")
        echo("  No aedesign.json found. Let's set up.")
        echo("")
