...
import aedesign.sample.composeapp.generated.resources.source_tab_code
import aedesign.sample.composeapp.generated.resources.source_tab_docs
import com.ae.design.sample.docs.catalog.ComponentRegistry
import com.ae.design.sample.docs.sources.SourceCodeViewer
...
fun PageContent(
    ...
    Column(modifier = Modifier.widthIn(max = 900.dp)) {
        val guide = com.ae.design.sample.docs.catalog.guidePages.find { it.id == selectedId }
        if (guide != null) {
            guide.content()
            return@Column
        }
